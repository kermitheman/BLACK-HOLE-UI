...
[BLACK HOLE UI (BLHL)](https://github.com/kermitheman/BLACK-HOLE-UI) is a c++ library for use in a [OpenGl](https://www.opengl.org) or [Vulkan](https://www.vulkan.org) , and posibly in the future [DirectX12](https://en.wikipedia.org/wiki/DirectX) project , also used in [my](https://github.com/kermitheman) engine.  
...
I **strongly** advice to read the [**Manual**](https://github.com/kermitheman/BLACK-HOLE-UI/blob/main/DOCS/Manual.md) for instruction & begginer guide.
